...
try:
    ...
    print(f"✓ Database directory ensured")
...
if size == 0:
    print(f"❌ ERROR: Database file is empty (0 bytes)")
    print(f"  This means no tables were created")
    sys.exit(1)
...
try:
    ...
    if count > 0:
        ...
        print(f"❌ ERROR: No sites found in database!")
        sys.exit(1)
