...
from routes import parse_gpx_file, calculate_gpx_stats
        ...
        for flight_data in real_flights:
            ...
            try:
                ...
                flight = Flight(
                    ...
                    duration_minutes=int(stats["flight_duration_seconds"] / 60) if stats["flight_duration_seconds"] > 0 else None,
                    distance_km=round(stats["total_distance_km"], 2),
                    max_altitude_m=stats["max_altitude_m"],
                    elevation_gain_m=stats["elevation_gain_m"],
                    max_speed_kmh=round(stats["max_speed_kmh"], 1) if stats["max_speed_kmh"] > 0 else None,
