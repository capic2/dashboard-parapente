...
async def main():
    ...
    urls_to_try = [
        f"https://www.meteociel.fr/prevville.php?ville=Arguel&x=0&y=0",
        f"https://www.meteociel.fr/previsions-arome-025/25720.htm",
        f"https://www.meteociel.fr/previsions-arome-hd/25720.htm",
        f"https://www.meteociel.fr/previsions-arome-015/25720.htm",
    ]
    
    async with httpx.AsyncClient(timeout=30, follow_redirects=True) as client:
        # First, search for the city
        search_url = "https://www.meteociel.fr/prevville.php?ville=Arguel"
        print(f"Searching for Arguel...")
