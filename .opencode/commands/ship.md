...
- For frontend changes, run `NX_NO_CLOUD=true /home/capic/.local/share/pnpm/pnpm nx affected -t lint frontend`, `NX_NO_CLOUD=true /home/capic/.local/share/pnpm/pnpm nx test frontend`, and `NX_NO_CLOUD=true /home/capic/.local/share/pnpm/pnpm nx build frontend`.
- For backend changes, run `NX_NO_CLOUD=true /home/capic/.local/share/pnpm/pnpm nx affected -t lint backend` and `NX_NO_CLOUD=true /home/capic/.local/share/pnpm/pnpm nx test backend`.
