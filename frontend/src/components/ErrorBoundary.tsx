...
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render(): ReactNode {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-purple-600 to-indigo-700" role="alert">
          <div className="max-w-2xl w-full bg-white rounded-xl shadow-2xl p-8">
            ...
            <div className="flex gap-3 flex-wrap">
              <button 
                ...
                className="px-6 py-3 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700 transition-all hover:shadow-lg"
              >
                🔄 Réessayer
              </button>
              <button 
