  ...
  return (
    <header className="bg-white dark:bg-gray-800 rounded-xl p-4 mb-4 shadow-lg flex justify-between items-center flex-wrap gap-2.5">
      ...
      <nav className="flex gap-2 flex-wrap items-center w-full sm:w-auto justify-center sm:justify-start">
        ...
        {/* <Link
          to="/thermal"
          className="px-3.5 py-2 rounded-md text-gray-600 dark:text-gray-300 text-sm transition-all hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-purple-600 [&.active]:bg-purple-600 [&.active]:text-white"
        >
          🌡️ Thermique
        </Link>*/}
        <Link
