...
describe('FlightDetails GoPro overlay action', () => {
  ...
  it('embeds every YouTube video attached to the flight', () => {
    ...
    expect(players[0]).toHaveAttribute(
      'src',
      'https://www.youtube.com/embed/dQw4w9WgXcQ?enablejsapi=1&origin=http%3A%2F%2Flocalhost%3A3000'
    );
    ...
    expect(players[1]).toHaveAttribute(
      'src',
      'https://www.youtube.com/embed/9bZkp7q19f0?enablejsapi=1&origin=http%3A%2F%2Flocalhost%3A3000'
    );
    expect(
