  ...
  return (
    <div className="py-4 space-y-4">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md flex flex-wrap items-center gap-3">
        ...
        <Button
          onPress={() => refetch()}
          className="px-4 py-2.5 sm:px-3 sm:py-1.5 rounded-md bg-sky-600 text-white text-sm hover:bg-sky-700 transition-colors cursor-pointer"
        >
          {t('cache.refresh')}
        </Button>
        <TextField
        ...
        <Button
          ...
          className="px-4 py-2.5 sm:px-3 sm:py-1.5 rounded-md bg-red-600 text-white text-sm hover:bg-red-700 transition-colors disabled:opacity-50 cursor-pointer"
        >
          {t('cache.clearAll')}
        </Button>
      </div>
        ...
        cell: (info) => (
          <div className="flex gap-2">
            <Button
              ...
              className="px-3 py-2 sm:px-2 sm:py-1 rounded text-xs bg-sky-100 dark:bg-sky-900 text-sky-700 dark:text-sky-300 hover:bg-sky-200 dark:hover:bg-sky-800 transition-colors cursor-pointer"
            >
              {t('cache.view')}
            </Button>
            <Button
