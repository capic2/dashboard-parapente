...
def parse_text_list_sounding(raw_text: str) -> dict[str, Any] | None:
    """
...
async def fetch_closest_sounding(
    user_lat: float, user_lon: float, sounding_time: str = "12", date: datetime | None = None
) -> dict[str, Any]:
    """
    ...
    result = await fetch_wyoming_sounding(
        station_code=closest["code"], sounding_time=sounding_time, date=date
    )
