...
def test_worker_listens_to_overlay_queue_only(monkeypatch) -> None:
    ...
    monkeypatch.setattr(gopro_overlay_worker, "get_queue", lambda _queue_name: overlay_queue)
    ...
    worker_factory.assert_called_once_with([overlay_queue], connection="redis")
